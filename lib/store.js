...
function Store(token) {
    ...
    this.local    = new finder(path.join(homeDir, '/.mvvm-store'));


    this.config  = new Storage('store', path.join(homeDir, '/.mvvm.json'));
    this.config.set('localDir', join(homeDir, '/.mvvm-store/'))
...
Store.prototype.saveApp = function () {
    var _this = this;
    this.pkg.set('local_path', join(homeDir, '/.mvvm-store/', this.pkg.get('name')));
    this.pkg.set('updated', Date.now())
